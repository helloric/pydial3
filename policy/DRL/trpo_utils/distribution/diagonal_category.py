...
from policy.DRL.trpo_utils.distribution.utils import *
...
class DiagonalCategory(object):
    ...
    def kl_sym(self, old_dist_info_vars, new_dist_info_vars):
        return tf.reduce_mean(input_tensor=old_dist_info_vars * tf.math.log((old_dist_info_vars + 1e-8) / (new_dist_info_vars + 1e-8)))
    ...
    def entropy(self, dist_infos):
        return tf.reduce_mean(input_tensor=-dist_infos * tf.math.log(dist_infos + 1e-8))
